...
//    }
    ...
    @GetMapping("total/number/flower")
    public String getTotalNumberFlower(Model model) {
        return sellerService.getTotalNumberFlower(model);
    }
    @GetMapping("total/number/flower/api")
    public GetTotalNumberFlowerResponse getTotalNumberFlower() {
        return sellerService.getTotalNumberFlowerAPI();
    }
    //--------------------------------------------------------------------------//
    //Get sold quantity category
    @GetMapping("sold/quantity/category")
    public String getSoldQuantityCategory(Model model) {
        return sellerService.getSoldQuantityCategory(model);
    }
    @GetMapping("sold/quantity/category/api")
    public GetSoldQuantityCategoryResponse getSoldQuantityCategory() {
        return sellerService.getSoldQuantityCategoryAPI();
    }
    //--------------------------------------------------------------------------//
    //Get total number of canceled order
    @GetMapping("total/number/cancel/order")
    public String getTotalNumberOfCanceledOrder(Model model) {
        return sellerService.getTotalNumberOfCanceledOrder(model);
    }
    @GetMapping("total/number/cancel/order/api")
    public GetTotalNumberOfCanceledOrderResponse getTotalNumberOfCanceledOrder() {
        return sellerService.getTotalNumberOfCanceledOrderAPI();
    }
    //--------------------------------------------------------------------------//
    //Get total number of order
    @GetMapping("total/number/order")
    public String getTotalNumberOfOrder(Model model) {
        return sellerService.getTotalNumberOfOrder(model);
    }
    @GetMapping("total/number/order/api")
    public GetTotalNumberOfOrderResponse getTotalNumberOfOrder() {
        return sellerService.getTotalNumberOfOrderAPI();
    }
    //--------------------------------------------------------------------------//
    //Get revenue
    @GetMapping("get/revenue")
    public String getRevenue(Model model) {
        return sellerService.getRevenue(model);
    }
    @GetMapping("get/revenue/api")
    public GetRevenueResponse getRevenue() {
        return sellerService.getRevenue();
    }

    //--------------------------------------------------------------------------//
    //Get order in daily
    @GetMapping("get/order/in/daily")
    public String getOrderInDaily(Model model) {
        return sellerService.getOrderInDaily(model);
    }
    @GetMapping("get/order/in/daily/api")
    public GetOrderInDailyResponse getOrderInDaily() {
        return sellerService.getOrderInDailyAPI();
    }
}
