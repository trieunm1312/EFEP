            ...
            public void run(String... args) throws Exception {
                ...
                Flower flower2 = flowerRepo.save(
                        Flower.builder()
                                ...
                                .seller(seller1)
                                .soldQuantity(0)
                                .createDate(LocalDateTime.of(2024, 2, 1, 0, 0))
                                .status(Status.FLOWER_STATUS_AVAILABLE)
                                .flowerCategoryList(null)
                                .orderDetailList(null)
                                .wishlistItemList(null)
                ...
                Flower flower3 = flowerRepo.save(
                        Flower.builder()
                                ...
                                .seller(seller1)
                                .soldQuantity(0)
                                .createDate(LocalDateTime.of(2024, 3, 1, 0, 0))
                                .status(Status.FLOWER_STATUS_AVAILABLE)
                                .flowerCategoryList(null)
                                .orderDetailList(null)
                                .wishlistItemList(null)
                ...
                Flower flower4 = flowerRepo.save(
                        Flower.builder()
                                ...
                                .seller(seller1)
                                .soldQuantity(0)
                                .createDate(LocalDateTime.of(2024, 4, 1, 0, 0))
                                .status(Status.FLOWER_STATUS_AVAILABLE)
                                .flowerCategoryList(null)
                                .orderDetailList(null)
                                .wishlistItemList(null)
                ...
                Flower flower5 = flowerRepo.save(
                        Flower.builder()
                                ...
                                .seller(seller1)
                                .soldQuantity(0)
                                .createDate(LocalDateTime.of(2024, 5, 1, 0, 0))
                                .status(Status.FLOWER_STATUS_AVAILABLE)
                                .flowerCategoryList(null)
                                .orderDetailList(null)
                                .wishlistItemList(null)
                ...
                Flower flower6 = flowerRepo.save(
                        Flower.builder()
                                ...
                                .seller(seller1)
                                .soldQuantity(0)
                                .createDate(LocalDateTime.of(2024, 6, 1, 0, 0))
                                .status(Status.FLOWER_STATUS_AVAILABLE)
                                .flowerCategoryList(null)
                                .orderDetailList(null)
                                .wishlistItemList(null)
                ...
                Flower flower7 = flowerRepo.save(
                        Flower.builder()
                                ...
                                .seller(seller1)
                                .soldQuantity(0)
                                .createDate(LocalDateTime.of(2024, 7, 1, 0, 0))
                                .status(Status.FLOWER_STATUS_AVAILABLE)
                                .flowerCategoryList(null)
                                .orderDetailList(null)
                                .wishlistItemList(null)
